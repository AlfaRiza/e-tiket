    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Hak Akses User</h2>
                    <?php echo form_open("auth/user_group");?>
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="p-t-6">
                                        <label class="radio-container m-r-45">Peserta
                                            <input type="radio" name="groups" id="groups" checked="checked" value="members">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="radio-container">Penyelenggara
                                            <input type="radio" name="groups" id="groups" value="penyelenggara">
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                </div>
